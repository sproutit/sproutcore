...
SC.stringsFor('English', {
  ...
  '_SC.ExceptionHandler.Error': 'Error',
  '_SC.ExceptionHandler.Message': 'An error has occurred which prevents the application from running:',
  '_SC.ExceptionHandler.Reload': 'Reload'
});
